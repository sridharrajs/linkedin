...
var oauthParameters = {
	//
	requestUrl: 'https://api.linkedin.com/uas/oauth/requestToken?scope=r_fullprofile+r_emailaddress+r_contactinfo',
	// 
...
function api(uri, callback) {
	...
	this.oauth.getProtectedResource(
		linkedinBaseUrl + uri,
		'GET',
		this.access.oauth_access_token,
		this.access.oauth_access_token_secret,
...
function post(uri, post_body, callback) {
  this.oauth.post(
		linkedinBaseUrl + uri,
		this.access.oauth_access_token,
		this.access.oauth_access_token_secret,
